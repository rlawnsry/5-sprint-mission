...
public class UserController {
    ...
    public ResponseEntity<User> updateUser(@PathVariable UUID id, UserUpdateRequest userRequest, BinaryContentCreateRequest contentRequest) {
        User savedUser = userService.update(id, userRequest, Optional.ofNullable(contentRequest));
        return ResponseEntity.status(201).body(savedUser);
    }
